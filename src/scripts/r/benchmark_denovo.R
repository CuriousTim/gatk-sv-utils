...
text(0.35, 0.1, labels = "input VCF", cex = 1, adj = 0.5)
text(0.9, 0.5, labels = "Belyeu", cex = 1, adj = 0.5)
text(0.35, 0.85, labels = "de novo pipeline", cex = 1, adj = 0.5)
text(0.9, 0.4, labels = length(truth_not_in_input_vcf), cex = 2, adj = 0.5)
